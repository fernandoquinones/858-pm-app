...
// Client Hub is per-hub gated (overrides global roles): Nic, Beth, Christina
// can edit; everyone else (incl. owner Fernando, JG, Caitlin, Marty) is view-only.
// Owner can add themselves here anytime.
export const CLIENT_HUB_EDITORS = ['Fernando', 'Nic', 'Beth', 'Christina']
export function canEditClientHub(name) {
  return CLIENT_HUB_EDITORS.includes(name)
}
