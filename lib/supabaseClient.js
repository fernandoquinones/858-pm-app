...
export const OWNERS = [
  'Christina', 'Fernando', 'Nic', 'JG', 'Caitlin', 'Beth', 'Marty', 'Nola',
  'TBD', 'Team'
]
export const OWNER_COLOR = {
  Christina: '#185FA5', Fernando: '#1D9E75', Nic: '#993C1D', JG: '#534AB7',
  Caitlin: '#9B2D6E', Beth: '#0F7B8A', Marty: '#854F0B', Nola: '#1D6E6E',
  TBD: '#9aa1ad', Team: '#5f5e5a'
}
export const STATUS = { todo: 'To do', prog: 'In progress', hold: 'On hold', ongoing: 'Ongoing', review: 'Needs review', done: 'Done' }
